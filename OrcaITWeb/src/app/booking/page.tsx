...
export const metadata: Metadata = {
  ...
  description:
    "Book Orca IT online. Select remote or on-site services, share your details, and request a quote. No solution, no fee.",
};
      ...
      <section className="px-5 pb-10 pt-8 sm:pt-10 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
            Select the help you need, tell us a little about yourself, and we&apos;ll get back
            to you quickly with clear next steps.
          </p>
